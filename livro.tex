...
\subsection{Como se proteger?}
	...
	Softwares como o \textbf{\textit{DNSCrypt-Proxy}} também tentam bloquear anúncios à nível de DNS.\\
	Para usuários que se preocupam mais com a privacidade, existe a extensão \textbf{\textit{NoScript}} que bloqueia todos os scripts JavaScript por padrão e também o \textbf{\textit{µMatrix}}, que permite selecionar com ainda mais precisão com que tipo de funcionalidades pode interagir.
