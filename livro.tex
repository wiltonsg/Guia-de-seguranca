\documentclass[12pt, letterpaper, Sans Regular:12]{report}
...
\section{Segurança física - Protegendo você e o hardware}
	...
	Com tantas tecnologias surgindo sem parar, é normal que tenha surgido e que irão surgir novas tecnologias para invasão de computadores, quando se tem acesso físico à máquina.
	\subsection{Os perigos}
	...
	Não são apenas estes dispositivos que estão ao alcance dos usuários. Existem diversos no mercado, como você pode \href{https://hakshop.com/}{ver aqui}. Existem aparelhos como o \href{https://hakshop.com/products/lan-turtle}{Lan Turtle}, que é utilizado para fazer um ataque MITM (\textit{Man In The Middle}).\\

	Se o público já tem acesso a estes dispositivos, para invadir servidores e quebrar a segurança deles, imaginem o que agências governamentais, como a CIA, NSA, Abin (\textit{Agência Brasileira de Inteligência}) e diversas outras agências tem em seu arsenal.\\
